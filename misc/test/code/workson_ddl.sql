...
CREATE TABLE
    workson (
        ...
        CONSTRAINT FK_workson_emp FOREIGN KEY (eno) REFERENCES emp (eno) ON UPDATE CASCADE ON DELETE CASCADE,
        CONSTRAINT FK_workson_proj FOREIGN KEY (pno) REFERENCES proj (pno) ON UPDATE CASCADE ON DELETE CASCADE
    );
